...
from services.plaid_service import create_link_token as create_plaid_link_token, exchange_public_token
...
def ask_agent():
    ...
    if not agent_executor:
        return jsonify({"error": "Agent not initialized. Please link your bank account."}), 400
